        ...
        <>
            ...
            <header className="p-4 flex items-center justify-between">
                ...
                <div class="flex space-x-4 items-center">
                    ...
                    <a href="#" class="bg-indigo-600 px-4 py-2 rounded text-white hover:bg-indigo-500 text-sm">Sign up</a>
                </div>
            </header>
            {/* Navigation bar */}
                ...
                <div class="px-5 py-3">
                    <div class="flex items-center">
                        <ul class="flex flex-row font-medium mt-0 space-x-8 text-sm">
                            ...
                            <li>
                                <a href="#" class="text-gray-900 dark:text-white hover:underline">Events</a>
                            </li>
                            <li>
