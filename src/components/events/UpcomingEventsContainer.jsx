...
function UpcomingEventsContainer({ events, user, isLoggedIn }) {
    return (
        <>  
            ...
            <div className="max-w-[85rem] px-14 py-2 sm:px-4 lg:px-4 lg:py-2 mx-auto animate-in slide-in-from-top ease-out duration-1.5s">
                <div className="flex flex-col">
                    ...
                    <div className="p-1.5 min-w-full inline-block align-middle">
                        ...
                        {/* <!-- Body --> */}
                        <div className="w-full min-h-[300px] flex flex-col mx-auto mx-4 bg-blue-50">
