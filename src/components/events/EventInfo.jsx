        ...
        <div className="flex justify-center py-4">
            <div className='py-4 mx-4 border-2  rounded-xl shadow-lg bg-white animate-in slide-in-from-top fade-in-25 ease-out duration-1.25s'>
                ...
                <div className="flex">
                    ...
                    <div className="h-[300px] w-[200px] bg-slate-500 animate-in slide-in-from-left fade-in-25 ease-out duration-1000">Image</div>
                    <div className="h-[200px] w-[200px] bg-blue-400 animate-in slide-in-from-left fade-in-25 ease-out duration-1000">Maps</div>
                    </div>
