    ...
    return (
        <>
           ...
           {/* <!-- Upcoming Anime Container --> */}
            <div className="max-w-[85rem] px-4 py-2 sm:px-4 lg:px-4 lg:py-2 mx-auto animate-in slide-in-from-top ease-out duration-1.5s">
            <div className="flex flex-col">
                ...
                <div className="p-1.5 min-w-full inline-block align-middle">
                    ...
                    <div className="px-6 py-4 border-b border-gray-200 bg-slate-900">
                        ...
                        Don not miss out on these exciting new shows.
                        </p>
                    </div>
                    {/* <!-- End Header --> */}

                    {/* <!-- Body --> */}
                    <div className="max-w-[300px] min-h-[300px] flex flex-col mx-auto px-6 py-1">
